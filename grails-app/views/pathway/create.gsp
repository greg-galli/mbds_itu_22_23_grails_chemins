...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            <section class="row">
                <a href="#create-pathway" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            ...
            <section class="row">
                <div id="create-pathway" class="col-12 content scaffold-create" role="main">
                    ...
                    <g:form resource="${this.pathway}" method="POST">
                        <fieldset class="form">
                            <f:all bean="pathway"/>
                        </fieldset>
